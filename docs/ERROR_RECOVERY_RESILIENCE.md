...
```bash
# Check health
curl https://cricket-bid-arena.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://cricket-bid-arena.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://cricket-bid-arena.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://cricket-bid-arena.preview.emergentagent.com/api/health"
...
curl -v https://cricket-bid-arena.preview.emergentagent.com/api/health
