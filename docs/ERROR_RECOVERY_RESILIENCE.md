...
```bash
# Check health
curl https://fantasy-ux-pilot.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://fantasy-ux-pilot.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fantasy-ux-pilot.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fantasy-ux-pilot.preview.emergentagent.com/api/health"
...
curl -v https://fantasy-ux-pilot.preview.emergentagent.com/api/health
