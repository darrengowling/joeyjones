...
watch -n 30 curl -s https://fixturemaster.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fixturemaster.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fixturemaster.preview.emergentagent.com/api/health"
...
curl -v https://fixturemaster.preview.emergentagent.com/api/health
