...
```bash
# Check health
curl https://fastbid-platform.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://fastbid-platform.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fastbid-platform.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fastbid-platform.preview.emergentagent.com/api/health"
...
curl -v https://fastbid-platform.preview.emergentagent.com/api/health
