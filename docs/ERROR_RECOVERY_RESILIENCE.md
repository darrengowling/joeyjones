...
```bash
# Check health
curl https://restart-auction.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://restart-auction.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://restart-auction.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://restart-auction.preview.emergentagent.com/api/health"
...
curl -v https://restart-auction.preview.emergentagent.com/api/health
