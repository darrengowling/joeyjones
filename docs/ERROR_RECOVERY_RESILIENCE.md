...
watch -n 30 curl -s https://leaguepilot.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://leaguepilot.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://leaguepilot.preview.emergentagent.com/api/health"
...
curl -v https://leaguepilot.preview.emergentagent.com/api/health
