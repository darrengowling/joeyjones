...
```bash
# Check health
curl https://bid-fixer.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://bid-fixer.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://bid-fixer.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://bid-fixer.preview.emergentagent.com/api/health"
...
curl -v https://bid-fixer.preview.emergentagent.com/api/health
