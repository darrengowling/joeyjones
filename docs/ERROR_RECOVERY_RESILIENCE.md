...
```bash
# Check health
curl https://speedrail.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://speedrail.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://speedrail.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://speedrail.preview.emergentagent.com/api/health"
...
curl -v https://speedrail.preview.emergentagent.com/api/health
