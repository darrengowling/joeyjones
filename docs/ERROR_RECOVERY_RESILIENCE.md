...
watch -n 30 curl -s https://cricket-football-2.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://cricket-football-2.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://cricket-football-2.preview.emergentagent.com/api/health"
...
curl -v https://cricket-football-2.preview.emergentagent.com/api/health
