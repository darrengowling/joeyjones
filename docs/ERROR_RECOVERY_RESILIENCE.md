...
```bash
# Check health
curl https://fantasy-sports-uk.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://fantasy-sports-uk.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fantasy-sports-uk.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fantasy-sports-uk.preview.emergentagent.com/api/health"
...
curl -v https://fantasy-sports-uk.preview.emergentagent.com/api/health
