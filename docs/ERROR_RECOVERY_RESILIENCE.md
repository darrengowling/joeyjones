...
```bash
# Check health
curl https://sportcrest.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://sportcrest.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://sportcrest.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://sportcrest.preview.emergentagent.com/api/health"
...
curl -v https://sportcrest.preview.emergentagent.com/api/health
