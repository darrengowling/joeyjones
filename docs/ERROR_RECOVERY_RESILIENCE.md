...
```bash
# Check health
curl https://livebid-2.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://livebid-2.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://livebid-2.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://livebid-2.preview.emergentagent.com/api/health"
...
curl -v https://livebid-2.preview.emergentagent.com/api/health
