...
```bash
# Check health
curl https://cricket-fantasy-app-2.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://cricket-fantasy-app-2.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://cricket-fantasy-app-2.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://cricket-fantasy-app-2.preview.emergentagent.com/api/health"
...
curl -v https://cricket-fantasy-app-2.preview.emergentagent.com/api/health
