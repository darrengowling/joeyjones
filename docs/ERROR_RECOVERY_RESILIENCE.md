...
```bash
# Check health
curl https://sportsbid-ux.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://sportsbid-ux.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://sportsbid-ux.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://sportsbid-ux.preview.emergentagent.com/api/health"
...
curl -v https://sportsbid-ux.preview.emergentagent.com/api/health
