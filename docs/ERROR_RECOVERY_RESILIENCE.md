...
```bash
# Check health
curl https://stitch-fantasy.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://stitch-fantasy.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://stitch-fantasy.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://stitch-fantasy.preview.emergentagent.com/api/health"
...
curl -v https://stitch-fantasy.preview.emergentagent.com/api/health
