...
```bash
# Check health
curl https://prod-stable-soccer.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://prod-stable-soccer.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://prod-stable-soccer.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://prod-stable-soccer.preview.emergentagent.com/api/health"
...
curl -v https://prod-stable-soccer.preview.emergentagent.com/api/health
