...
```bash
# Check health
curl https://competition-hub-6.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://competition-hub-6.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://competition-hub-6.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://competition-hub-6.preview.emergentagent.com/api/health"
...
curl -v https://competition-hub-6.preview.emergentagent.com/api/health
