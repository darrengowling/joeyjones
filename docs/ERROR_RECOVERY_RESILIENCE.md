...
watch -n 30 curl -s https://bidding-tester.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://bidding-tester.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://bidding-tester.preview.emergentagent.com/api/health"
...
curl -v https://bidding-tester.preview.emergentagent.com/api/health
