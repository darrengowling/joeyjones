...
```bash
# Check health
curl https://biddingprep.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://biddingprep.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://biddingprep.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://biddingprep.preview.emergentagent.com/api/health"
...
curl -v https://biddingprep.preview.emergentagent.com/api/health
