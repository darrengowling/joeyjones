...
watch -n 30 curl -s https://pilot-ready-deploy.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://pilot-ready-deploy.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://pilot-ready-deploy.preview.emergentagent.com/api/health"
...
curl -v https://pilot-ready-deploy.preview.emergentagent.com/api/health
