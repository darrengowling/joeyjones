...
```bash
# Check health
curl https://sports-auction-app.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://sports-auction-app.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://sports-auction-app.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://sports-auction-app.preview.emergentagent.com/api/health"
...
curl -v https://sports-auction-app.preview.emergentagent.com/api/health
