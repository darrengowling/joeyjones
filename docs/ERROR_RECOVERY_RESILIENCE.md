...
```bash
# Check health
curl https://fixture-correction.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://fixture-correction.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fixture-correction.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fixture-correction.preview.emergentagent.com/api/health"
...
curl -v https://fixture-correction.preview.emergentagent.com/api/health
