...
watch -n 30 curl -s https://fix-roster-sync.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://fix-roster-sync.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://fix-roster-sync.preview.emergentagent.com/api/health"
...
curl -v https://fix-roster-sync.preview.emergentagent.com/api/health
