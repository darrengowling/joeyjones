...
```bash
# Check health
curl https://sportauction.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://sportauction.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://sportauction.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://sportauction.preview.emergentagent.com/api/health"
...
curl -v https://sportauction.preview.emergentagent.com/api/health
