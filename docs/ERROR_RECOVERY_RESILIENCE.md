...
```bash
# Check health
curl https://draft-kings-mobile.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://draft-kings-mobile.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://draft-kings-mobile.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://draft-kings-mobile.preview.emergentagent.com/api/health"
...
curl -v https://draft-kings-mobile.preview.emergentagent.com/api/health
