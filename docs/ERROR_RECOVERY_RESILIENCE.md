...
```bash
# Check health
curl https://prelaunch-fix.preview.emergentagent.com/api/health

# Continuous monitoring (every 30s)
watch -n 30 curl -s https://prelaunch-fix.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://prelaunch-fix.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://prelaunch-fix.preview.emergentagent.com/api/health"
...
curl -v https://prelaunch-fix.preview.emergentagent.com/api/health
