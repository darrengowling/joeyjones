...
watch -n 30 curl -s https://bat-and-ball-18.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://bat-and-ball-18.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://bat-and-ball-18.preview.emergentagent.com/api/health"
...
curl -v https://bat-and-ball-18.preview.emergentagent.com/api/health
