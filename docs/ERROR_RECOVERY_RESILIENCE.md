...
watch -n 30 curl -s https://sport-predictor-9.preview.emergentagent.com/api/health
```
...
1. Monitor: `https://sport-predictor-9.preview.emergentagent.com/api/health`
...
```bash
#!/bin/bash
HEALTH_URL="https://sport-predictor-9.preview.emergentagent.com/api/health"
...
curl -v https://sport-predictor-9.preview.emergentagent.com/api/health
