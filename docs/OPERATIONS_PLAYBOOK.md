...
curl -w "@-" -o /dev/null -s https://bat-and-ball-18.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://bat-and-ball-18.preview.emergentagent.com/api/auth/magic-link \
