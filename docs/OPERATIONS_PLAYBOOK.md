...
**Frontend Status**:
```bash
curl -I https://competition-hub-6.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://competition-hub-6.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://competition-hub-6.preview.emergentagent.com/api/auth/magic-link \
