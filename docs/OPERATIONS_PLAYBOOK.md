...
curl -w "@-" -o /dev/null -s https://bidding-tester.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://bidding-tester.preview.emergentagent.com/api/auth/magic-link \
