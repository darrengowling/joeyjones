...
**Frontend Status**:
```bash
curl -I https://cricket-bid-arena.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://cricket-bid-arena.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://cricket-bid-arena.preview.emergentagent.com/api/auth/magic-link \
