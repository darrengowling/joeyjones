...
**Frontend Status**:
```bash
curl -I https://cricket-fantasy-app-2.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://cricket-fantasy-app-2.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://cricket-fantasy-app-2.preview.emergentagent.com/api/auth/magic-link \
