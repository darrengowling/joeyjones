...
**Frontend Status**:
```bash
curl -I https://sportsbid-ux.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://sportsbid-ux.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://sportsbid-ux.preview.emergentagent.com/api/auth/magic-link \
