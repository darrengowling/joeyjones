...
**Frontend Status**:
```bash
curl -I https://bid-fixer.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://bid-fixer.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://bid-fixer.preview.emergentagent.com/api/auth/magic-link \
