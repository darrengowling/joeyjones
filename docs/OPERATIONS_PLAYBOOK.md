...
**Frontend Status**:
```bash
curl -I https://sportauction.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://sportauction.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://sportauction.preview.emergentagent.com/api/auth/magic-link \
