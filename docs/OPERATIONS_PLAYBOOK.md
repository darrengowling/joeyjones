...
**Frontend Status**:
```bash
curl -I https://speedrail.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://speedrail.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://speedrail.preview.emergentagent.com/api/auth/magic-link \
