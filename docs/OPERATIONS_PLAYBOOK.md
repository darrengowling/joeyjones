...
**Frontend Status**:
```bash
curl -I https://sportcrest.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://sportcrest.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://sportcrest.preview.emergentagent.com/api/auth/magic-link \
