...
curl -w "@-" -o /dev/null -s https://auction-hardening.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://auction-hardening.preview.emergentagent.com/api/auth/magic-link \
