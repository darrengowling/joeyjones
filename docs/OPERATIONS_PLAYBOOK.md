...
curl -w "@-" -o /dev/null -s https://cricket-football-2.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://cricket-football-2.preview.emergentagent.com/api/auth/magic-link \
