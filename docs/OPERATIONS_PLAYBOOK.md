...
**Frontend Status**:
```bash
curl -I https://draft-kings-mobile.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://draft-kings-mobile.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://draft-kings-mobile.preview.emergentagent.com/api/auth/magic-link \
