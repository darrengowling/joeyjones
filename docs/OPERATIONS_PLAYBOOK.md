...
**Frontend Status**:
```bash
curl -I https://fantasy-sports-uk.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://fantasy-sports-uk.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://fantasy-sports-uk.preview.emergentagent.com/api/auth/magic-link \
