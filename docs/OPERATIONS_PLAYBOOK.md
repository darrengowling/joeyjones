...
curl -w "@-" -o /dev/null -s https://pilot-ready-deploy.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://pilot-ready-deploy.preview.emergentagent.com/api/auth/magic-link \
