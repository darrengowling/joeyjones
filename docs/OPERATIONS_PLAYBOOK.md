...
**Frontend Status**:
```bash
curl -I https://biddingprep.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://biddingprep.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://biddingprep.preview.emergentagent.com/api/auth/magic-link \
