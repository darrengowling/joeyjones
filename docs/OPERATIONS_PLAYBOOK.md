...
**Frontend Status**:
```bash
curl -I https://stitch-fantasy.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://stitch-fantasy.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://stitch-fantasy.preview.emergentagent.com/api/auth/magic-link \
