...
**Frontend Status**:
```bash
curl -I https://prod-stable-soccer.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://prod-stable-soccer.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://prod-stable-soccer.preview.emergentagent.com/api/auth/magic-link \
