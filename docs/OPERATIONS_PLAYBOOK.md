...
**Frontend Status**:
```bash
curl -I https://livebid-2.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://livebid-2.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://livebid-2.preview.emergentagent.com/api/auth/magic-link \
