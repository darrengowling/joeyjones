...
**Frontend Status**:
```bash
curl -I https://uxoverhaul-1.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://uxoverhaul-1.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://uxoverhaul-1.preview.emergentagent.com/api/auth/magic-link \
