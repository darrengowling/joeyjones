...
curl -w "@-" -o /dev/null -s https://fix-roster-sync.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://fix-roster-sync.preview.emergentagent.com/api/auth/magic-link \
