...
**Frontend Status**:
```bash
curl -I https://sporty-ui.preview.emergentagent.com
...
curl -w "@-" -o /dev/null -s https://sporty-ui.preview.emergentagent.com/api/sports <<< "time_total: %{time_total}s"
```
...
curl -X POST https://sporty-ui.preview.emergentagent.com/api/auth/magic-link \
