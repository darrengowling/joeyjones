...
- Access at: `https://fantasy-sports-bid.preview.emergentagent.com/socketio-test.html`
...
```
Request: https://fantasy-sports-bid.preview.emergentagent.com/api/socket.io
         ↓
