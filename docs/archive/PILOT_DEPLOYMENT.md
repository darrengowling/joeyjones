...
FRONTEND_ORIGIN="https://bidding-tester.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://bidding-tester.preview.emergentagent.com`.
...
```
1. Open: https://bidding-tester.preview.emergentagent.com/api/metrics
