...
FRONTEND_ORIGIN="https://fantasy-auction-test.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://fantasy-auction-test.preview.emergentagent.com`.
...
```
1. Open: https://fantasy-auction-test.preview.emergentagent.com/api/metrics
