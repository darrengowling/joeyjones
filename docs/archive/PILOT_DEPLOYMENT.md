...
FRONTEND_ORIGIN="https://speedrail.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://speedrail.preview.emergentagent.com`.
...
```
1. Open: https://speedrail.preview.emergentagent.com/api/metrics
