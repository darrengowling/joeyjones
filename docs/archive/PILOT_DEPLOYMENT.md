...
FRONTEND_ORIGIN="https://bid-ux-update.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://bid-ux-update.preview.emergentagent.com`.
...
```
1. Open: https://bid-ux-update.preview.emergentagent.com/api/metrics
