...
FRONTEND_ORIGIN="https://stitch-dark-theme.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://stitch-dark-theme.preview.emergentagent.com`.
...
```
1. Open: https://stitch-dark-theme.preview.emergentagent.com/api/metrics
