...
FRONTEND_ORIGIN="https://sportauction.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://sportauction.preview.emergentagent.com`.
...
```
1. Open: https://sportauction.preview.emergentagent.com/api/metrics
