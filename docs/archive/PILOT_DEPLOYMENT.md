...
FRONTEND_ORIGIN="https://sportsbid-ux.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://sportsbid-ux.preview.emergentagent.com`.
...
```
1. Open: https://sportsbid-ux.preview.emergentagent.com/api/metrics
