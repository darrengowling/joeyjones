...
FRONTEND_ORIGIN="https://sportcrest.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://sportcrest.preview.emergentagent.com`.
...
```
1. Open: https://sportcrest.preview.emergentagent.com/api/metrics
