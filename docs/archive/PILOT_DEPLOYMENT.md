...
FRONTEND_ORIGIN="https://fastbid-platform.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://fastbid-platform.preview.emergentagent.com`.
...
```
1. Open: https://fastbid-platform.preview.emergentagent.com/api/metrics
