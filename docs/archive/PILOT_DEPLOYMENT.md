...
FRONTEND_ORIGIN="https://fantasy-sports-bid.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://fantasy-sports-bid.preview.emergentagent.com`.
...
```
1. Open: https://fantasy-sports-bid.preview.emergentagent.com/api/metrics
