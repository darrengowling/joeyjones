...
FRONTEND_ORIGIN="https://fixturemaster.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://fixturemaster.preview.emergentagent.com`.
...
```
1. Open: https://fixturemaster.preview.emergentagent.com/api/metrics
