...
FRONTEND_ORIGIN="https://sporty-ui.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://sporty-ui.preview.emergentagent.com`.
...
```
1. Open: https://sporty-ui.preview.emergentagent.com/api/metrics
