...
FRONTEND_ORIGIN="https://uxoverhaul-1.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://uxoverhaul-1.preview.emergentagent.com`.
...
```
1. Open: https://uxoverhaul-1.preview.emergentagent.com/api/metrics
