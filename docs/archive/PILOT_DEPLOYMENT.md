...
FRONTEND_ORIGIN="https://stitch-fantasy.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://stitch-fantasy.preview.emergentagent.com`.
...
```
1. Open: https://stitch-fantasy.preview.emergentagent.com/api/metrics
