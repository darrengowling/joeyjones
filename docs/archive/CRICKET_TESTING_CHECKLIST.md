...
OR manually via API:
```bash
curl -X POST "https://fixturemaster.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://fixturemaster.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
