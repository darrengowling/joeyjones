...
OR manually via API:
```bash
curl -X POST "https://speedrail.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://speedrail.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
