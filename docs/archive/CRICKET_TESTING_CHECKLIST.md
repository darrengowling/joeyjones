...
OR manually via API:
```bash
curl -X POST "https://sporty-ui.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://sporty-ui.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
