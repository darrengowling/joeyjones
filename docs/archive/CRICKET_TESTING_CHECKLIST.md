...
OR manually via API:
```bash
curl -X POST "https://sportsbid-ux.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://sportsbid-ux.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
