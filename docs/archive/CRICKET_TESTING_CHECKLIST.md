...
OR manually via API:
```bash
curl -X POST "https://uxoverhaul-1.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://uxoverhaul-1.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
