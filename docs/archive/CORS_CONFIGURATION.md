...
**After:**
```bash
CORS_ORIGINS="https://fantasy-auction-test.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://fantasy-auction-test.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://fantasy-auction-test.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-auction-test.preview.emergentagent.com" \
...
```bash
curl -X GET "https://fantasy-auction-test.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-auction-test.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://fantasy-auction-test.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://fantasy-auction-test.preview.emergentagent.com/api/health" \
  -H "Origin: https://fantasy-auction-test.preview.emergentagent.com" \
...
fetch('https://fantasy-auction-test.preview.emergentagent.com/api/sports', {
  credentials: 'include',
