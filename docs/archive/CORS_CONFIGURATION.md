...
**After:**
```bash
CORS_ORIGINS="https://speedrail.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://speedrail.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://speedrail.preview.emergentagent.com/api/sports" \
  -H "Origin: https://speedrail.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://speedrail.preview.emergentagent.com
...
```bash
curl -X GET "https://speedrail.preview.emergentagent.com/api/sports" \
  -H "Origin: https://speedrail.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://speedrail.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://speedrail.preview.emergentagent.com/api/health" \
  -H "Origin: https://speedrail.preview.emergentagent.com" \
...
fetch('https://speedrail.preview.emergentagent.com/api/sports', {
  credentials: 'include',
