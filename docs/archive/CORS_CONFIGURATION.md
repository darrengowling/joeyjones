...
**After:**
```bash
CORS_ORIGINS="https://fantasy-ux-pilot.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://fantasy-ux-pilot.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://fantasy-ux-pilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-ux-pilot.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://fantasy-ux-pilot.preview.emergentagent.com
...
```bash
curl -X GET "https://fantasy-ux-pilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-ux-pilot.preview.emergentagent.com"
```
...
curl -X OPTIONS "https://fantasy-ux-pilot.preview.emergentagent.com/api/health" \
  -H "Origin: https://fantasy-ux-pilot.preview.emergentagent.com" \
...
fetch('https://fantasy-ux-pilot.preview.emergentagent.com/api/sports', {
  credentials: 'include',
