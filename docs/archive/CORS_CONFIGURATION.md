...
**After:**
```bash
CORS_ORIGINS="https://stitch-fantasy.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://stitch-fantasy.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://stitch-fantasy.preview.emergentagent.com/api/sports" \
  -H "Origin: https://stitch-fantasy.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://stitch-fantasy.preview.emergentagent.com
...
```bash
curl -X GET "https://stitch-fantasy.preview.emergentagent.com/api/sports" \
  -H "Origin: https://stitch-fantasy.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://stitch-fantasy.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://stitch-fantasy.preview.emergentagent.com/api/health" \
  -H "Origin: https://stitch-fantasy.preview.emergentagent.com" \
...
fetch('https://stitch-fantasy.preview.emergentagent.com/api/sports', {
  credentials: 'include',
