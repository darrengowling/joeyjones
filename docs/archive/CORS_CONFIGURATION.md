...
**After:**
```bash
CORS_ORIGINS="https://uxoverhaul-1.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://uxoverhaul-1.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://uxoverhaul-1.preview.emergentagent.com/api/sports" \
  -H "Origin: https://uxoverhaul-1.preview.emergentagent.com" \
...
```bash
curl -X GET "https://uxoverhaul-1.preview.emergentagent.com/api/sports" \
  -H "Origin: https://uxoverhaul-1.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://uxoverhaul-1.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://uxoverhaul-1.preview.emergentagent.com/api/health" \
  -H "Origin: https://uxoverhaul-1.preview.emergentagent.com" \
...
fetch('https://uxoverhaul-1.preview.emergentagent.com/api/sports', {
  credentials: 'include',
