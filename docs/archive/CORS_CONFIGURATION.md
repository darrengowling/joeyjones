...
**After:**
```bash
CORS_ORIGINS="https://sportauction.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sportauction.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sportauction.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportauction.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sportauction.preview.emergentagent.com
...
```bash
curl -X GET "https://sportauction.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportauction.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://sportauction.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://sportauction.preview.emergentagent.com/api/health" \
  -H "Origin: https://sportauction.preview.emergentagent.com" \
...
fetch('https://sportauction.preview.emergentagent.com/api/sports', {
  credentials: 'include',
