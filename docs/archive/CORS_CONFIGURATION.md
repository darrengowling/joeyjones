...
**After:**
```bash
CORS_ORIGINS="https://sportsbid-ux.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sportsbid-ux.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sportsbid-ux.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportsbid-ux.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sportsbid-ux.preview.emergentagent.com
...
```bash
curl -X GET "https://sportsbid-ux.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportsbid-ux.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://sportsbid-ux.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://sportsbid-ux.preview.emergentagent.com/api/health" \
  -H "Origin: https://sportsbid-ux.preview.emergentagent.com" \
...
fetch('https://sportsbid-ux.preview.emergentagent.com/api/sports', {
  credentials: 'include',
