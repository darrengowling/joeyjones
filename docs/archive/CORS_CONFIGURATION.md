...
**After:**
```bash
CORS_ORIGINS="https://bidding-tester.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://bidding-tester.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://bidding-tester.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bidding-tester.preview.emergentagent.com" \
...
```bash
curl -X GET "https://bidding-tester.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bidding-tester.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://bidding-tester.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://bidding-tester.preview.emergentagent.com/api/health" \
  -H "Origin: https://bidding-tester.preview.emergentagent.com" \
...
fetch('https://bidding-tester.preview.emergentagent.com/api/sports', {
  credentials: 'include',
