...
**After:**
```bash
CORS_ORIGINS="https://sporty-ui.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sporty-ui.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sporty-ui.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sporty-ui.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sporty-ui.preview.emergentagent.com
...
```bash
curl -X GET "https://sporty-ui.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sporty-ui.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://sporty-ui.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://sporty-ui.preview.emergentagent.com/api/health" \
  -H "Origin: https://sporty-ui.preview.emergentagent.com" \
...
fetch('https://sporty-ui.preview.emergentagent.com/api/sports', {
  credentials: 'include',
