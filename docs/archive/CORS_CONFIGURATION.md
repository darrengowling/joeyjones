...
**After:**
```bash
CORS_ORIGINS="https://fantasy-sports-uk.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://fantasy-sports-uk.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://fantasy-sports-uk.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-sports-uk.preview.emergentagent.com" \
...
```bash
curl -X GET "https://fantasy-sports-uk.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fantasy-sports-uk.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://fantasy-sports-uk.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://fantasy-sports-uk.preview.emergentagent.com/api/health" \
  -H "Origin: https://fantasy-sports-uk.preview.emergentagent.com" \
...
fetch('https://fantasy-sports-uk.preview.emergentagent.com/api/sports', {
  credentials: 'include',
