...
**After:**
```bash
CORS_ORIGINS="https://sportcrest.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sportcrest.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sportcrest.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportcrest.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sportcrest.preview.emergentagent.com
...
```bash
curl -X GET "https://sportcrest.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sportcrest.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://sportcrest.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://sportcrest.preview.emergentagent.com/api/health" \
  -H "Origin: https://sportcrest.preview.emergentagent.com" \
...
fetch('https://sportcrest.preview.emergentagent.com/api/sports', {
  credentials: 'include',
