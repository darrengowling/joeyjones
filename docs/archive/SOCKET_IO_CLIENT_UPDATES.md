...
```env
REACT_APP_BACKEND_URL=https://uxoverhaul-1.preview.emergentagent.com
REACT_APP_BUILD_HASH=1363bfb
```
...
1. **Start auction in preview:**
   ```
   https://uxoverhaul-1.preview.emergentagent.com
   ```

2. **Check debug footer shows:**
   - Backend: `https://uxoverhaul-1.preview.emergentagent.com`
   - Socket: `/api/socket.io`
