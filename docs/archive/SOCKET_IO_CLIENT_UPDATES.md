...
```env
REACT_APP_BACKEND_URL=https://sportcrest.preview.emergentagent.com
REACT_APP_BUILD_HASH=1363bfb
```
...
1. **Start auction in preview:**
   ```
   https://sportcrest.preview.emergentagent.com
   ```

2. **Check debug footer shows:**
   - Backend: `https://sportcrest.preview.emergentagent.com`
   - Socket: `/api/socket.io`
