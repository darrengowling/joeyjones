...
**Get All Fixtures**
```bash
curl https://stitch-fantasy.preview.emergentagent.com/api/fixtures?sport_key=football
```
...
```bash
curl https://stitch-fantasy.preview.emergentagent.com/api/fixtures/{fixture_id}
```
