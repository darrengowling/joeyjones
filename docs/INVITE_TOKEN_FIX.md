...
```bash
curl "https://prod-stable-soccer.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://prod-stable-soccer.preview.emergentagent.com/api/leagues | \
