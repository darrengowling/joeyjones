...
```bash
curl "https://auction-hardening.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://auction-hardening.preview.emergentagent.com/api/leagues | \
