...
```bash
curl "https://pilot-ready-deploy.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://pilot-ready-deploy.preview.emergentagent.com/api/leagues | \
