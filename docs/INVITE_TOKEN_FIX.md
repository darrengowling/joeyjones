...
```bash
curl "https://fantasy-sports-bid.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://fantasy-sports-bid.preview.emergentagent.com/api/leagues | \
