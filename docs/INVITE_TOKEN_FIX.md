...
```bash
curl "https://fantasy-sports-uk.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://fantasy-sports-uk.preview.emergentagent.com/api/leagues | \
