...
```bash
curl "https://sport-predictor-9.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://sport-predictor-9.preview.emergentagent.com/api/leagues | \
