...
```bash
curl "https://stitch-dark-theme.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://stitch-dark-theme.preview.emergentagent.com/api/leagues | \
