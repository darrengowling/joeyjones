...
```bash
curl "https://draft-kings-mobile.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://draft-kings-mobile.preview.emergentagent.com/api/leagues | \
