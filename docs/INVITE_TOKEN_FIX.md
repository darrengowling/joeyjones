...
```bash
curl "https://cricket-fantasy-app-2.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://cricket-fantasy-app-2.preview.emergentagent.com/api/leagues | \
