...
```bash
curl "https://fantasy-auction-test.preview.emergentagent.com/api/leagues/by-token/b3015725"
```
...
# Verify cleanup
curl https://fantasy-auction-test.preview.emergentagent.com/api/leagues | \
