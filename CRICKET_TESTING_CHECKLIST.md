...
OR manually via API:
```bash
curl -X POST "https://auction-hardening.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://auction-hardening.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
