...
OR manually via API:
```bash
curl -X POST "https://cricket-football-2.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://cricket-football-2.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
