...
OR manually via API:
```bash
curl -X POST "https://sport-predictor-9.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://sport-predictor-9.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
