...
OR manually via API:
```bash
curl -X POST "https://sports-auction-1.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://sports-auction-1.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
