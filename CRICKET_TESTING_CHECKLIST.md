...
OR manually via API:
```bash
curl -X POST "https://bat-and-ball-18.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://bat-and-ball-18.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
