...
OR manually via API:
```bash
curl -X POST "https://auction-buddy-8.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://auction-buddy-8.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
