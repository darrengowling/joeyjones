...
OR manually via API:
```bash
curl -X POST "https://multisport-auction.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/ingest" \
...
```bash
# Via API
curl "https://multisport-auction.preview.emergentagent.com/api/scoring/YOUR_LEAGUE_ID/leaderboard" | jq
