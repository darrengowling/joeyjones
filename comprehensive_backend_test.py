...
BACKEND_URL = "https://prod-stable-soccer.preview.emergentagent.com/api"
...
class BackendTester:
    ...
    def test_socket_io_configuration(self):
        ...
        try:
            ...
            response = requests.get(f"https://prod-stable-soccer.preview.emergentagent.com/api/socket.io/")
