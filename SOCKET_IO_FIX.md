...
- Access at: `https://prod-stable-soccer.preview.emergentagent.com/socketio-test.html`
...
```
Request: https://prod-stable-soccer.preview.emergentagent.com/api/socket.io
         ↓
