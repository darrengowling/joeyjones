...
FRONTEND_ORIGIN="https://prelaunch-fix.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://prelaunch-fix.preview.emergentagent.com`.
...
```
1. Open: https://prelaunch-fix.preview.emergentagent.com/api/metrics
