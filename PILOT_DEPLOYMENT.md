...
FRONTEND_ORIGIN="https://bidflowfix.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://bidflowfix.preview.emergentagent.com`.
...
```
1. Open: https://bidflowfix.preview.emergentagent.com/api/metrics
