...
FRONTEND_ORIGIN="https://sports-auction-app.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://sports-auction-app.preview.emergentagent.com`.
...
```
1. Open: https://sports-auction-app.preview.emergentagent.com/api/metrics
