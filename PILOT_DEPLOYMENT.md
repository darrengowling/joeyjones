...
FRONTEND_ORIGIN="https://cricket-bid-arena.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://cricket-bid-arena.preview.emergentagent.com`.
...
```
1. Open: https://cricket-bid-arena.preview.emergentagent.com/api/metrics
