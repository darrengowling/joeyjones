...
FRONTEND_ORIGIN="https://bid-fixer.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://bid-fixer.preview.emergentagent.com`.
...
```
1. Open: https://bid-fixer.preview.emergentagent.com/api/metrics
