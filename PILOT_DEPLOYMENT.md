...
FRONTEND_ORIGIN="https://multisport-bid.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://multisport-bid.preview.emergentagent.com`.
...
```
1. Open: https://multisport-bid.preview.emergentagent.com/api/metrics
