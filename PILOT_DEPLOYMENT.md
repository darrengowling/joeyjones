...
FRONTEND_ORIGIN="https://prod-stable-soccer.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://prod-stable-soccer.preview.emergentagent.com`.
...
```
1. Open: https://prod-stable-soccer.preview.emergentagent.com/api/metrics
