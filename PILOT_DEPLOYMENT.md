...
FRONTEND_ORIGIN="https://pilot-ready-deploy.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://pilot-ready-deploy.preview.emergentagent.com`.
...
```
1. Open: https://pilot-ready-deploy.preview.emergentagent.com/api/metrics
