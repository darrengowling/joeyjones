...
FRONTEND_ORIGIN="https://bid-socket-system.preview.emergentagent.com"
...
**Result:** CORS restricted to `https://bid-socket-system.preview.emergentagent.com`.
...
```
1. Open: https://bid-socket-system.preview.emergentagent.com/api/metrics
