    ...
    <div className="min-h-screen font-sans" style={{ background: 'var(--bg-base, #0F172A)', paddingBottom: '100px' }}>
        ...
        <div className="flex justify-start gap-2 mb-6 overflow-x-auto pb-2 -mx-4 px-4" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
          {['overview', 'managers', uiHints.assetPlural.toLowerCase(), 'fixtures'].map((tab) => (
            <button
              ...
              className="px-4 py-2.5 rounded-full text-sm font-bold uppercase tracking-wide whitespace-nowrap transition-all flex-shrink-0"
              style={{
        ...
        {activeTab === 'fixtures' && (
          <div className="space-y-4">
            ...
            {loadingFixtures ? (
              ...
              <>
                {/* Upcoming Fixtures - includes scheduled, in_play, live, postponed, etc. */}
      ...
      {editingAssets && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ background: 'rgba(0,0,0,0.7)' }}>
          <div className="w-full max-w-md h-full max-h-screen flex flex-col" style={{ background: 'var(--bg-base, #0F172A)' }}>
          {/* Modal Header */}
          <header 
