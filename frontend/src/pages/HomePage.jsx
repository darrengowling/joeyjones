  ...
  return (
    ...
    >
      ...
      <main className="pt-24 px-6 pb-6 space-y-8">
        ...
        {/* About Sport X Section */}
        <section className="space-y-4">
          <div className="flex items-end justify-between px-1">
            <h3 className="text-xl font-black uppercase tracking-tighter text-white">About Sport X</h3>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h4 className="font-black text-white uppercase tracking-tight text-sm">Why We Do It</h4>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h4 className="font-black text-white uppercase tracking-tight text-sm">How It Works</h4>
            </div>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'rgba(6, 182, 212, 0.15)' }}>
                  <span className="text-xs font-black" style={{ color: '#06B6D4' }}>1</span>
                </div>
                <div>
                  <span className="text-white font-bold text-sm">THE AUCTION</span>
                  <p className="text-slate-400 text-xs leading-relaxed">Enter a high-tension live auction. Use your fixed budget to bid on teams in real-time.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'rgba(6, 182, 212, 0.15)' }}>
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs leading-relaxed">Once you win a bid, that team is yours and yours alone. Build a roster of elite clubs to compete in your private league.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'rgba(6, 182, 212, 0.15)' }}>
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs leading-relaxed">We sync with real-world matches. Every goal, win and draw in the real world earns you points in the app.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5" style={{ background: 'rgba(6, 182, 212, 0.15)' }}>
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-xs leading-relaxed">Outsmart your rivals, climb the standings and claim the ultimate championship badge.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <h4 className="font-black uppercase tracking-tight text-sm" style={{ color: '#06B6D4' }}>The Sport X Manifesto</h4>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-sm" style={{ color: '#06B6D4' }}>check_circle</span>
                <span className="text-white text-sm"><strong>SKILL OVER LUCK</strong> <span className="text-slate-400">— Success is earned through scouting and strategy</span></span>
              </div>
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-sm" style={{ color: '#06B6D4' }}>check_circle</span>
              ...
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-sm" style={{ color: '#06B6D4' }}>check_circle</span>
                <span className="text-white text-sm"><strong>GLORY OVER MONEY</strong> <span className="text-slate-400">— The prize is bragging rights</span></span>
              </div>
            </div>
          </div>
        </section>
