...
**After:**
```bash
CORS_ORIGINS="https://leaguepilot.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://leaguepilot.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://leaguepilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://leaguepilot.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://leaguepilot.preview.emergentagent.com
...
```bash
curl -X GET "https://leaguepilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://leaguepilot.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://leaguepilot.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://leaguepilot.preview.emergentagent.com/api/health" \
  -H "Origin: https://leaguepilot.preview.emergentagent.com" \
...
fetch('https://leaguepilot.preview.emergentagent.com/api/sports', {
  credentials: 'include',
