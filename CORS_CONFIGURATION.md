...
**After:**
```bash
CORS_ORIGINS="https://pilot-ready-deploy.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://pilot-ready-deploy.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://pilot-ready-deploy.preview.emergentagent.com/api/sports" \
  -H "Origin: https://pilot-ready-deploy.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://pilot-ready-deploy.preview.emergentagent.com
...
```bash
curl -X GET "https://pilot-ready-deploy.preview.emergentagent.com/api/sports" \
  -H "Origin: https://pilot-ready-deploy.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://pilot-ready-deploy.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://pilot-ready-deploy.preview.emergentagent.com/api/health" \
  -H "Origin: https://pilot-ready-deploy.preview.emergentagent.com" \
...
fetch('https://pilot-ready-deploy.preview.emergentagent.com/api/sports', {
  credentials: 'include',
