...
**After:**
```bash
CORS_ORIGINS="https://bid-socket-system.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://bid-socket-system.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://bid-socket-system.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bid-socket-system.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://bid-socket-system.preview.emergentagent.com
...
```bash
curl -X GET "https://bid-socket-system.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bid-socket-system.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://bid-socket-system.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://bid-socket-system.preview.emergentagent.com/api/health" \
  -H "Origin: https://bid-socket-system.preview.emergentagent.com" \
...
fetch('https://bid-socket-system.preview.emergentagent.com/api/sports', {
  credentials: 'include',
