...
**After:**
```bash
CORS_ORIGINS="https://prelaunch-fix.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://prelaunch-fix.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://prelaunch-fix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://prelaunch-fix.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://prelaunch-fix.preview.emergentagent.com
...
```bash
curl -X GET "https://prelaunch-fix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://prelaunch-fix.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://prelaunch-fix.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://prelaunch-fix.preview.emergentagent.com/api/health" \
  -H "Origin: https://prelaunch-fix.preview.emergentagent.com" \
...
fetch('https://prelaunch-fix.preview.emergentagent.com/api/sports', {
  credentials: 'include',
