...
### Allowed Origins
- **Current:** `https://fix-roster-sync.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://fix-roster-sync.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fix-roster-sync.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://fix-roster-sync.preview.emergentagent.com
...
```bash
curl -X GET "https://fix-roster-sync.preview.emergentagent.com/api/sports" \
  -H "Origin: https://fix-roster-sync.preview.emergentagent.com"
```
...
curl -X OPTIONS "https://fix-roster-sync.preview.emergentagent.com/api/health" \
  -H "Origin: https://fix-roster-sync.preview.emergentagent.com" \
...
fetch('https://fix-roster-sync.preview.emergentagent.com/api/sports', {
  credentials: 'include',
