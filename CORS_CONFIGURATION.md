...
**After:**
```bash
CORS_ORIGINS="https://sport-predictor-9.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sport-predictor-9.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sport-predictor-9.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sport-predictor-9.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sport-predictor-9.preview.emergentagent.com
...
```bash
curl -X GET "https://sport-predictor-9.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sport-predictor-9.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://sport-predictor-9.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://sport-predictor-9.preview.emergentagent.com/api/health" \
  -H "Origin: https://sport-predictor-9.preview.emergentagent.com" \
...
fetch('https://sport-predictor-9.preview.emergentagent.com/api/sports', {
  credentials: 'include',
