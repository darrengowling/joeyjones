...
**After:**
```bash
CORS_ORIGINS="https://multisport-bid.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://multisport-bid.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://multisport-bid.preview.emergentagent.com/api/sports" \
  -H "Origin: https://multisport-bid.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://multisport-bid.preview.emergentagent.com
...
```bash
curl -X GET "https://multisport-bid.preview.emergentagent.com/api/sports" \
  -H "Origin: https://multisport-bid.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://multisport-bid.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://multisport-bid.preview.emergentagent.com/api/health" \
  -H "Origin: https://multisport-bid.preview.emergentagent.com" \
...
fetch('https://multisport-bid.preview.emergentagent.com/api/sports', {
  credentials: 'include',
