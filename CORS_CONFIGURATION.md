...
**After:**
```bash
CORS_ORIGINS="https://auction-hardening.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://auction-hardening.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://auction-hardening.preview.emergentagent.com/api/sports" \
  -H "Origin: https://auction-hardening.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://auction-hardening.preview.emergentagent.com
...
```bash
curl -X GET "https://auction-hardening.preview.emergentagent.com/api/sports" \
  -H "Origin: https://auction-hardening.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://auction-hardening.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://auction-hardening.preview.emergentagent.com/api/health" \
  -H "Origin: https://auction-hardening.preview.emergentagent.com" \
...
fetch('https://auction-hardening.preview.emergentagent.com/api/sports', {
  credentials: 'include',
