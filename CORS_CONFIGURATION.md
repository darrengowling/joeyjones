...
**After:**
```bash
CORS_ORIGINS="https://biddingprep.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://biddingprep.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://biddingprep.preview.emergentagent.com/api/sports" \
  -H "Origin: https://biddingprep.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://biddingprep.preview.emergentagent.com
...
```bash
curl -X GET "https://biddingprep.preview.emergentagent.com/api/sports" \
  -H "Origin: https://biddingprep.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://biddingprep.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://biddingprep.preview.emergentagent.com/api/health" \
  -H "Origin: https://biddingprep.preview.emergentagent.com" \
...
fetch('https://biddingprep.preview.emergentagent.com/api/sports', {
  credentials: 'include',
