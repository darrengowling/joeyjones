...
**After:**
```bash
CORS_ORIGINS="https://prod-auction-fix.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://prod-auction-fix.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://prod-auction-fix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://prod-auction-fix.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://prod-auction-fix.preview.emergentagent.com
...
```bash
curl -X GET "https://prod-auction-fix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://prod-auction-fix.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://prod-auction-fix.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://prod-auction-fix.preview.emergentagent.com/api/health" \
  -H "Origin: https://prod-auction-fix.preview.emergentagent.com" \
...
fetch('https://prod-auction-fix.preview.emergentagent.com/api/sports', {
  credentials: 'include',
