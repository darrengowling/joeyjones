...
**After:**
```bash
CORS_ORIGINS="https://sports-auction-app.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://sports-auction-app.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://sports-auction-app.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sports-auction-app.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://sports-auction-app.preview.emergentagent.com
...
```bash
curl -X GET "https://sports-auction-app.preview.emergentagent.com/api/sports" \
  -H "Origin: https://sports-auction-app.preview.emergentagent.com"
```
...
curl -X OPTIONS "https://sports-auction-app.preview.emergentagent.com/api/health" \
  -H "Origin: https://sports-auction-app.preview.emergentagent.com" \
...
fetch('https://sports-auction-app.preview.emergentagent.com/api/sports', {
  credentials: 'include',
