...
### Allowed Origins
- **Current:** `https://restart-auction.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://restart-auction.preview.emergentagent.com/api/sports" \
  -H "Origin: https://restart-auction.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://restart-auction.preview.emergentagent.com
...
```bash
curl -X GET "https://restart-auction.preview.emergentagent.com/api/sports" \
  -H "Origin: https://restart-auction.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://restart-auction.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://restart-auction.preview.emergentagent.com/api/health" \
  -H "Origin: https://restart-auction.preview.emergentagent.com" \
...
fetch('https://restart-auction.preview.emergentagent.com/api/sports', {
  credentials: 'include',
