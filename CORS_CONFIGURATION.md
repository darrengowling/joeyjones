...
**After:**
```bash
CORS_ORIGINS="https://bidflowfix.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://bidflowfix.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://bidflowfix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bidflowfix.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://bidflowfix.preview.emergentagent.com
...
```bash
curl -X GET "https://bidflowfix.preview.emergentagent.com/api/sports" \
  -H "Origin: https://bidflowfix.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://bidflowfix.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://bidflowfix.preview.emergentagent.com/api/health" \
  -H "Origin: https://bidflowfix.preview.emergentagent.com" \
...
fetch('https://bidflowfix.preview.emergentagent.com/api/sports', {
  credentials: 'include',
