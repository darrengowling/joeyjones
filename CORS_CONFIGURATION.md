...
**After:**
```bash
CORS_ORIGINS="https://auctionpilot.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://auctionpilot.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://auctionpilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://auctionpilot.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://auctionpilot.preview.emergentagent.com
...
```bash
curl -X GET "https://auctionpilot.preview.emergentagent.com/api/sports" \
  -H "Origin: https://auctionpilot.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://auctionpilot.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://auctionpilot.preview.emergentagent.com/api/health" \
  -H "Origin: https://auctionpilot.preview.emergentagent.com" \
...
fetch('https://auctionpilot.preview.emergentagent.com/api/sports', {
  credentials: 'include',
