...
**After:**
```bash
CORS_ORIGINS="https://leaguemaster-6.preview.emergentagent.com"
```
...
### Allowed Origins
- **Current:** `https://leaguemaster-6.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://leaguemaster-6.preview.emergentagent.com/api/sports" \
  -H "Origin: https://leaguemaster-6.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://leaguemaster-6.preview.emergentagent.com
...
```bash
curl -X GET "https://leaguemaster-6.preview.emergentagent.com/api/sports" \
  -H "Origin: https://leaguemaster-6.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://leaguemaster-6.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://leaguemaster-6.preview.emergentagent.com/api/health" \
  -H "Origin: https://leaguemaster-6.preview.emergentagent.com" \
...
fetch('https://leaguemaster-6.preview.emergentagent.com/api/sports', {
  credentials: 'include',
