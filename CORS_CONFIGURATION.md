...
### Allowed Origins
- **Current:** `https://draft-kings-mobile.preview.emergentagent.com`
...
```bash
curl -X OPTIONS "https://draft-kings-mobile.preview.emergentagent.com/api/sports" \
  -H "Origin: https://draft-kings-mobile.preview.emergentagent.com" \
  -H "Access-Control-Request-Method: GET"
```

**Result:** ✅ PASS
```
access-control-allow-origin: https://draft-kings-mobile.preview.emergentagent.com
...
```bash
curl -X GET "https://draft-kings-mobile.preview.emergentagent.com/api/sports" \
  -H "Origin: https://draft-kings-mobile.preview.emergentagent.com"
```
...
```json
{
  "method": "OPTIONS",
  "path": "/api/sports",
  "origin": "https://draft-kings-mobile.preview.emergentagent.com",
  "cors_allowed": true,
  "status": 200
}
```
...
curl -X OPTIONS "https://draft-kings-mobile.preview.emergentagent.com/api/health" \
  -H "Origin: https://draft-kings-mobile.preview.emergentagent.com" \
...
fetch('https://draft-kings-mobile.preview.emergentagent.com/api/sports', {
  credentials: 'include',
