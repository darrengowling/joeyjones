...
4. Check leaderboard:
```bash
curl "https://prod-auction-fix.preview.emergentagent.com/api/scoring/LEAGUE_ID/leaderboard" | jq
```
...
**Auction URLs:**
- League: https://prod-auction-fix.preview.emergentagent.com/leagues/00039867-9555-4990-a5f5-f068f8afbcce
