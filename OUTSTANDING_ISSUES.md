...
|----|-------|---------------|----------|
| - | Debug report incomplete | Dec 19, 2025 | Enhanced to capture 15 socket events + server state. Auto-uploads to server with reference ID. Query via `/api/debug/reports` |
